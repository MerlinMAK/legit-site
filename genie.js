...
(function () {
  ...
  var CSS = [
    ...
    ".lg-input input{flex:1;background:var(--bg,#0A0E17);border:1.5px solid var(--line2,rgba(234,238,245,.18));border-radius:10px;padding:10px 12px;color:var(--ink,#EAEEF5);font-family:inherit;font-size:14px}",
